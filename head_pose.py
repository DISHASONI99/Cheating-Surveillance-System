...
# def process_head_pose(frame, calibrated_angles=None):
#     global previous_state, direction_start_time
...
#         # Track duration in same direction
...
#             if duration > 5:
#                 cv2.putText(frame, "WARNING: Look at the Screen!", (50, 400),
#                             cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

#         previous_state = current_state
#         head_direction = current_state

#         # Display pitch, yaw, roll on screen
#         cv2.putText(frame, f"Pitch: {pitch:.2f}", (20, 50),
#                     cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
#         cv2.putText(frame, f"Yaw: {yaw:.2f}", (20, 80),
#                     cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
#         cv2.putText(frame, f"Roll: {roll:.2f}", (20, 110),
#                     cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
#         cv2.putText(frame, f"Direction: {head_direction}", (20, 140),
...
#         frame, calibrated_angles = process_head_pose(frame, None)
#         cv2.putText(frame, "Calibrating... Look at the Screen!", (50, 400),
#                     cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
#     else:
#         frame, head_position = process_head_pose(frame, calibrated_angles)
